...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			class="w-full max-w-[180px] rounded-xl px-1 py-1.5 border border-gray-300/30 dark:border-gray-700/50 z-50 bg-white dark:bg-[#082556] dark:text-white shadow-sm"
			sideOffset={-2}
			side="bottom"
			align="start"
