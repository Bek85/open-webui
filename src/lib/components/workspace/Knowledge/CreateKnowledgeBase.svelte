		...
		<div class=" w-full flex flex-col justify-center">
			...
			<div class="w-full flex flex-col gap-2.5">
				...
				<div>
					...
					<div class=" w-full mt-1">
						<textarea
							class="w-full resize-none rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-gray-300 dark:bg-[#082556] outline-hidden"
							rows="4"
			...
			<div>
				<button
					class=" text-sm px-4 py-2 transition rounded-lg {loading
						...
						: ' bg-gray-50 hover:bg-gray-100 dark:bg-[#082556] dark:hover:bg-gray-800'} flex"
					type="submit"
					disabled={loading}
				>
