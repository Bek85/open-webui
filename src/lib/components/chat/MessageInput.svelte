		...
		<div class="bg-transparent dark:bg-[#082556]">
			...
			>
				<div class="">
					...
					<p class="px-2 pt-2 pb-2 text-center text-xs leading-5 text-gray-500 dark:text-gray-400">
						{$i18n.t(
							'Responses are generated by AI and may contain mistakes. Please double-check important information.'
						)}
					</p>
				</div>
			</div>
