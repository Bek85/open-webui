	...
	{#if collapsible}
		...
		>
			...
			<div
				...
				class=" w-full group rounded-xl relative flex items-center justify-between hover:bg-gray-100 dark:hover:bg-[#4CC9F0] dark:hover:text-[#ffffff] transition {buttonClassName}"
			>
