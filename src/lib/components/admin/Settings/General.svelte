				...
				<div class="mb-3.5">
					...
					<div class="mb-2.5">
						...
						<div class="flex w-full justify-between items-center">
							...
							{#if $config?.features?.enable_version_update_check}
								<button
									class=" text-xs px-3 py-1.5 bg-gray-50 hover:bg-gray-100 dark:bg-[#082556] dark:hover:bg-gray-800 transition rounded-lg font-medium"
									type="button"
									on:click={() => {
										checkForVersionUpdates();
									}}
					...
					<div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							...
							<!-- <button
								class="flex-shrink-0 text-xs px-3 py-1.5 bg-gray-50 hover:bg-gray-100 dark:bg-[#082556] dark:hover:bg-gray-800 transition rounded-lg font-medium"
							>
								{$i18n.t('Activate')}
							</button> -->
						</div>
