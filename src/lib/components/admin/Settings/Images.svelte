			...
			<div class="flex flex-col gap-2">
				{#if (config?.engine ?? 'automatic1111') === 'automatic1111'}
					<div>
						...
						<div class="flex w-full">
							...
							<button
								class="px-2.5 bg-gray-50 hover:bg-gray-100 text-gray-800 dark:bg-[#082556] dark:hover:bg-gray-800 dark:text-gray-100 rounded-lg transition"
								type="button"
								on:click={async () => {
				...
				{:else if config?.engine === 'comfyui'}
					...
					<div class="">
						...
						{#if config.comfyui.COMFYUI_WORKFLOW}
							<Textarea
								class="w-full rounded-lg mb-1 py-2 px-4 text-xs bg-gray-50 dark:text-gray-300 dark:bg-[#082556] outline-hidden disabled:text-gray-600 resize-none"
								rows="10"
