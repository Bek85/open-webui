...
<div
	class="flex gap-2.5 text-left min-w-[var(--width)] w-full dark:bg-[#082556] dark:text-white bg-white text-black border border-gray-100 dark:border-gray-800 rounded-3xl px-4 py-3.5 cursor-pointer select-none"
