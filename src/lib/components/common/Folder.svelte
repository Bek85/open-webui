...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			<div
				class="w-full group rounded-md relative flex items-center justify-between hover:bg-gray-100 dark:hover:bg-[#4CC9F0] text-gray-500 dark:text-gray-500 dark:hover:text-[#ffffff] transition"
			>
